    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, error_messages={'invalid_extension': 'This format does not supported.'}, null=True, upload_to='', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('jpg', 'png')), main.validators.validate_file_size], verbose_name='Photo')),
