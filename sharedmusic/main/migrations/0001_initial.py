    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('playlist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.playlist', verbose_name='Playlist')),
            ],
            options={
                'verbose_name': 'Room',
        ...
        migrations.AddField(
            model_name='playlist',
            name='current_track',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.soundtrack'),
        ),
    ]
